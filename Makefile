...
ALL: bin tmp bin/volrace bin/bufhrt bin/highrestest \
     ...
     bin/resample_soxr bin/cat64 bin/cleancp bin/cleancp2 bin/cleancp4
...
bin/cleancp2: src/version.h tmp/net.o src/cleancp2.c tmp/cprefresh.o tmp/cprefresh_ass.o |bin
	$(CC) $(CFLAGSNO) -o bin/cleancp2 tmp/cprefresh.o tmp/cprefresh_ass.o src/cleancp2.c -lpthread -lrt

bin/cleancp4: src/version.h tmp/net.o src/cleancp4.c tmp/cprefresh.o tmp/cprefresh_ass.o |bin
	$(CC) $(CFLAGSNO) -o bin/cleancp4 tmp/cprefresh.o tmp/cprefresh_ass.o src/cleancp4.c -lpthread -lrt
